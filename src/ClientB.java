...
public class ClientB {
    ...
    public static void main(String[] args) {
        ...
        String directoryPath = Constants.CLIENT_FILE_ROOT;
        ...
        do{
            ...
            switch (action) {
                    ...
                    for (int i = 0; i < index; i++) {
                        ...
                        for (int j = 0; j < localFiles.length; j++) {
                            if (files[i].equals(localFiles[j])){
                                ...
                                try {
                                    byte[] fileHash = calculateHash(Constants.CLIENT_FILE_ROOT + files[i], algorithm);
                ...
                case "DOWNLOAD":
                    ...
                    receiverPort=Constants.CLIENT_UDP_PORT;
                ...
                case "UPLOAD":
                    ...
                    System.out.println("Sending message: "+message);
                    //Connect to the server to download the file
                    senderPort=Constants.CLIENT_UDP_PORT;
    ...
    public static void receiveFile(InetAddress receiverIp,int receiverPort,InetAddress senderIp,int senderPort) {
        ...
        FileWriter fileWriter=new FileWriter(bm, Constants.CLIENT_FILE_ROOT);
        fileWriter.start();	
        try {
            packetReceiver.join();
            fileWriter.join();
