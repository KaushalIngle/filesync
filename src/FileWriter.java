...
public class FileWriter extends Thread {
	...
	public FileWriter() {}
	public FileWriter(PacketBoundedBufferMonitor bm, String directoryPath) {
		...
		try {
			...
			while(true) {
				...
				if (pkt.getIndex()==0) {
					...
					System.out.println(Constants.CRLF+">> Write the file "+directoryPath+fileName+Constants.CRLF);		      
			        file.createNewFile();			        	
